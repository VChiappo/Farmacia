  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="modal-title fs-5" id="exampleModalLabel">Confirmación de Eliminación</h2>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <input type="hidden" id="id_user"> <!-- Input oculto para el id_usuario -->
        ...
        <div class="alert alert-success text-center" id="confirmado" style="display: none;">
          <span><i class="fas fa-check m-1"></i>Usuario eliminado con éxito</span>
        </div>
        <div class="alert alert-danger text-center" id="rechazado" style="display: none;">
          <span><i class="fas fa-times m-1"></i>Error al eliminar el usuario</span>
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" data-bs-dismiss="modal" class="button btn btn-outline-secondary float-right m-1">Cancelar</button>
        <button type="button" id="btn-confirmar-eliminacion" class="btn bg-gradient-danger">Eliminar Usuario</button>
      </div>
    </div>
  </div>
</div>
          ...
          <div class="card-body">
            ...
            <form id="form-crear">
              ...
              <div class="form-group">
                ...
                <input id="dni_us" type="text" class="form-control" placeholder="Ingrese su DNI" required>
              </div>
              <div class="form-group">
