      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="alert alert-success text-center" id="edit" style="display: none;">
            <span><i class="fas fa-check m-1"></i>Avatar cambiado con éxito</span>
          </div>
            ...
            <div class="col-md-9">
              <div class="card card-success">
                ...
                <div class="card-body">
                  ...
                  <from id="form_editar_usuario" class="form-horizontal">
                    ...
                    <div class="form-group row">
                      <div class="offset-sm-2 col-sm-10 float-right">
                        <button onclick="editar_usuario()" class="btn btn-block btn-outline-success">Cambiar</button>
                      </div>
                    </div>
                    </form>
                </div>
...
<script>function editar_usuario(){
