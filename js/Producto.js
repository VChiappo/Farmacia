                ...
                <div class="card bg-light">
                    ...
                    <div class="row">
                        ...
                        <ul class="ml-4 mb-0 fa-ul text-muted">
                            ...
                            <li class="small"><span class="fa-li"><i class="fas fa-lg fa-flask"></i></span> Adicional: ${producto.laboratorio}</li>
                            <li class="small"><span class="fa-li"><i class="fas fa-lg fa-copyright"></i></span> Adicional: ${producto.tipo}</li>
                            <li class="small"><span class="fa-li"><i class="fas fa-lg fa-pills"></i></span> Adicional: ${producto.presentacion}</li>
                        </ul>
                        </div>
